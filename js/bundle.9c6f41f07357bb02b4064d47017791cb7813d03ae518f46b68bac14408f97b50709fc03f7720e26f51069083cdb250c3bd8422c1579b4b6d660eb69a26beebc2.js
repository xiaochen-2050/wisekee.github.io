...
const parentURL = 'https://blog.wisekee.com/';
...
function fileClosure(){ 
  ...
  (function navToggle() {
    doc.addEventListener('click', function(event){
      ...
      const harmburgerIcon = 'https://blog.wisekee.com/icons/bar.svg';
      const closeIcon = 'https://blog.wisekee.com/icons/cancel.svg';
      if(isNavToggle) {
        event.preventDefault();
